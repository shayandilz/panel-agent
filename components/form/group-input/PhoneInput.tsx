...
const PhoneInput: React.FC<PhoneInputProps> = ({
  ...
  return (
      <div style={{direction: 'ltr'}} className="relative flex">
        ...
        <input
            ...
            } rounded-lg border border-gray-300 bg-transparent py-3 px-4 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/60 dark:focus:border-brand-800`}
        />
