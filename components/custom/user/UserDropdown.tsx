...
export default function UserDropdown() {
    ...
    return (<div className="relative">
        ...
        >
            <div>
              <span className="block font-bold text-gray-700 text-theme-sm dark:text-gray-400">
                {agentData ? agentData.agent_gender : ''} {agentData ? agentData.agent_name : ''} {agentData ? agentData.agent_family : ''} ({agentData ? agentData.employee_name : ''} {agentData ? agentData.employee_family : ''})
              </span>
                <span className="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">
                {agentData ? agentData.agent_mobile : ''}
              </span>
            </div>
